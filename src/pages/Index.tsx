...
const gifts: GiftItem[] = [
	...
	{
		id: '4',
		name: 'Buffet Aparador',
		description: '',
		minValue: 700,
		maxValue: 700,
		observation: '',
		image: img('buffet-aparador.webp'),
	},
	{
		id: '5',
		name: 'Interfone eletrônico',
		description: '',
		minValue: 200,
		maxValue: 200,
		observation: '',
		image: img('interfone-eletronico.webp'),
	},
	{
		id: '6',
		...
		maxValue: 400,
		observation: '',
		image: img('caixa-de-som-bluethooth.webp'),
	},
	{
		id: '7',
		name: 'Câmera',
	...
	{
		id: '8',
		name: 'Assistente virtual Alexa',
		description: '',
		minValue: 460,
		maxValue: 460,
		observation: '',
		image: img('assistente-virtual-alexa.webp'),
	},
	{
		id: '9',
		name: 'Ventilador',
	...
	},
	{
		...
		maxValue: 130,
		observation: '',
		image: img('umidificador-de-ar.webp'),
	},
	{
		id: '11',
		...
		maxValue: 470,
		observation: '',
		image: img('purificador-de-água.webp'),
	},
	{
		id: '12',
		...
		maxValue: 900,
		observation: '',
		image: img('mesa-de-cozinha.webp'),
	},
	{
		id: '13',
		name: '4 cadeiras',
	...
	},
	{
		...
		maxValue: 150,
		observation: '',
		image: img('chaleira-eletrica.webp'),
	},
	{
		id: '23',
		name: 'Moedor de café',
	...
	},
	{
		...
		maxValue: 80,
		observation: '',
		image: img('escorredor-de-loucas.webp'),
	},
	{
		id: '25',
		name: 'Tábua de corte',
	...
	},
	{
		...
		maxValue: 30,
		observation: '',
		image: img('forma-de-bolo.webp'),
	},
	{
		id: '28',
		name: 'Assadeira grande e média',
		description: '',
		minValue: 70,
		maxValue: 70,
		observation: '',
		image: img('assadeira- grande-e-media.webp'),
	},
	{
		id: '29',
		...
		maxValue: 200,
		observation: '',
		image: img('panela-de-pressao.webp'),
	},
	{
		id: '30',
		name: 'Churrasqueira',
	...
	},
	{
		...
		maxValue: 70,
		observation: '',
		image: img('garrafa-termica.webp'),
	},
	{
		id: '32',
		name: 'Cama',
	...
	},
	{
		...
		maxValue: 300,
		observation: '',
		image: img('edredom-cobertor.webp'),
	},
	{
		id: '36',
		name: 'Travesseiros (2)',
	...
	},
	{
		...
		maxValue: 120,
		observation: '',
		image: img('protetor-de-colchao.webp'),
	},
	{
		id: '38',
		...
		maxValue: 150,
		observation: '',
		image: img('almofadas-decorativas.webp'),
	},
	{
		id: '39',
		name: 'Guarda-roupa',
	...
	},
	{
		...
		maxValue: 180,
		observation: '',
		image: img('torneira-de-banheiro.webp'),
	},
	{
		id: '43',
		...
		maxValue: 300,
		observation: '',
		image: img('espelho-de-banheiro.webp'),
	},
	{
		id: '44',
		name: 'Suporte de shampoo',
		description: '',
		minValue: 80,
		maxValue: 80,
		observation: '',
		image: img('suporte-de-shampoo.webp'),
	},
	{
		id: '45',
		...
		maxValue: 80,
		observation: '',
		image: img('tapete-de-banheiro.webp'),
	},
	{
		id: '46',
		...
		maxValue: 100,
		observation: '',
		image: img('toalhas-de-rosto.webp'),
	},
	{
		id: '47',
		...
		maxValue: 250,
		observation: '',
		image: img('toalhas-de-banho.webp'),
	},
	{
		id: '48',
		...
		maxValue: 50,
		observation: '',
		image: img('porta-escova-de-dente.webp'),
	},
	{
		id: '49',
		...
		maxValue: 2500,
		observation: '',
		image: img('maquina-de-lavar.webp'),
	},
	{
		id: '50',
		name: 'Varal ou estendal',
		description: '',
		minValue: 150,
		maxValue: 150,
		observation: '',
		image: img('varal-ou-estendal.webp'),
	},
	{
		id: '51',
		...
		maxValue: 500,
		observation: '',
		image: img('aspirador-vertical.webp'),
	},
	{
		id: '52',
		name: 'Robô inteligente varre/passa pano/aspira',
		description: '',
		minValue: 1500,
		maxValue: 1500,
		observation: '',
		image: img('robo-inteligente-varre-passa-pano-spira.webp'),
	},
	{
		id: '53',
		name: 'Vassoura',
	...
	},
	{
		...
		maxValue: 700,
		observation: '',
		image: img('mesa-externa.webp'),
	},
	{
		id: '57',
		name: 'Kit cadeira e mesa externa',
		description: '',
		minValue: 1200,
		maxValue: 1200,
		observation: '',
		image: img('kit-cadeira-e-mesa-externa.webp'),
	},
	{
		id: '58',
		name: 'Cadeira de bambu alumínio (4 lugares)',
		description: '',
		minValue: 1500,
		maxValue: 1500,
		observation: '',
		image: img('cadeira-de-bambu-aluminio.webp'),
	},
	{
		id: '59',
		name: 'Ajudar no terno do noivo',
		description: '',
		minValue: 300,
		maxValue: 300,
		observation: '',
		image: img('ajudar-no-terno-do-noivo.webp'),
	},
	{
		id: '60',
		name: 'Ajudar com a festa',
		description: '',
		minValue: 600,
		maxValue: 600,
		observation: '',
		image: img('ajudar-com-a-festa.webp'),
	},
	{
		id: '61',
		name: 'Ajudar no vestido da noiva',
		description: '',
		minValue: 300,
		maxValue: 300,
		observation: '',
		image: img('ajudar-no-vestido-da-noiva.webp'),
	},
	{
		id: '62',
		name: 'Cabelo e make da noiva',
		description: '',
		minValue: 600,
		maxValue: 600,
		observation: '',
		image: img('cabelo-e-make-da-noiva.webp'),
	},
	{
		id: '63',
		name: 'Buquê da noiva',
...
const Index = () => {
	...
	const scrollToGiftsTop = () => {
		...
		const top =
			giftsTopRef.current.getBoundingClientRect().top + window.scrollY - 104;
		...
		<div className="min-h-screen w-full max-w-full">
			...
			>
				...
				<div className="absolute inset-0 overflow-hidden pointer-events-none">
					<div
						data-hero-blob
						className="absolute top-20 left-10 w-32 h-32 bg-wedding-gold/10 rounded-full blur-xl"
					></div>
					<div
						data-hero-blob
						className="absolute bottom-20 right-10 w-40 h-40 bg-wedding-rose/10 rounded-full blur-xl"
					></div>
					<div
						data-hero-blob
						className="absolute top-1/2 left-1/4 w-24 h-24 bg-wedding-olive/10 rounded-full blur-lg"
					></div>
				</div>

				<div className="text-center relative z-10">
					<div data-hero-item className="mb-6">
						<span className="text-sm md:text-base text-wedding-olive font-medium tracking-wider uppercase">
					...
					<h1
						data-hero-item
						className="text-4xl md:text-6xl lg:text-7xl font-bold font-playfair mb-4 bg-gradient-to-r from-wedding-gold to-wedding-rose bg-clip-text text-transparent"
					>
						Luan & Cauane
					</h1>
					...
					<div
						data-hero-line
						className="w-full max-w-lg mx-auto h-px bg-gradient-to-r from-transparent via-wedding-olive to-transparent mb-8"
					></div>

					<p
						data-hero-item
						className="text-lg md:text-xl font-playfair mb-8 text-wedding-gold"
					>
					...
					<div data-hero-item className="mb-8">
						...
						<p className="text-xs text-wedding-olive font-medium">
							— Gênesis 2:24
						</p>
					</div>
					...
					<div data-hero-item className="flex justify-center mt-8">
						<div className="inline-flex flex-col sm:flex-row gap-4">
							...
							<a
								href="#presentes"
								className="btn-shine-olive py-4 px-10 border-2 border-wedding-olive text-wedding-olive rounded-full uppercase tracking-wide shadow-md hover:shadow-lg transition-all duration-300 font-medium text-lg text-center"
								onMouseMove={shineMove}
							>
								Lista de Presentes
							</a>
			...
			<section id="galeria" className="py-20 bg-white">
				<div className="container mx-auto px-4">
					<RevealOnScroll>
						<h2
							data-gsap-title
							className="text-3xl md:text-4xl font-playfair text-center mb-4"
						>
							Nossos Momentos
						</h2>
						<p
				...
				<div className="container mx-auto">
					...
					<div className="max-w-4xl mx-auto">
						<RevealOnScroll className="grid grid-cols-1 md:grid-cols-2 gap-8">
							<div
								data-gsap-card
								className="text-center p-8 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-wedding-olive/20 hover:shadow-xl transition-all duration-300"
							>
								<div className="w-16 h-16 bg-wedding-olive/10 rounded-full flex items-center justify-center mx-auto mb-4">
									<svg
										className="w-8 h-8 text-wedding-olive"
										fill="none"
										stroke="currentColor"
										viewBox="0 0 24 24"
									>
								...
								<h3 className="text-xl font-playfair mb-3 text-wedding-olive">
									Data e Hora
								</h3>
							...
							<div
								data-gsap-card
								className="text-center p-8 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-wedding-olive/20 hover:shadow-xl transition-all duration-300 md:col-span-2"
							>
								<div className="w-16 h-16 bg-wedding-olive/10 rounded-full flex items-center justify-center mx-auto mb-4">
									<svg
										className="w-8 h-8 text-wedding-olive"
			...
			<section id="localizacao" className="py-20 bg-white">
				<div className="container mx-auto">
					...
					<RevealOnScroll className="max-w-4xl mx-auto w-full">
						<div
							data-gsap-map
							className="rounded-lg overflow-hidden shadow-md w-full max-w-full"
						>
							<iframe
			...
			<section id="presentes" className="py-8 bg-white" ref={sectionRef}>
				<div className="container mx-auto">
					<div data-gsap-gift-header className="text-center mb-8">
						<div className="inline-flex items-center justify-center w-16 h-16 bg-wedding-olive/10 rounded-full mb-6">
					...
					<div className="flex flex-col lg:flex-row gap-6">
						...
						>
							<div ref={sidebarRef}>
								<Card className="bg-white/80 backdrop-blur-sm border-wedding-olive/20">
									<CardHeader className="pb-4">
										<div className="flex items-center justify-between">
											<CardTitle className="text-lg font-semibold text-wedding-olive flex items-center gap-2">
													...
													<button
														...
														className={`w-full text-left px-3 py-2 rounded-md text-sm transition-colors ${
															selectedPriceRange === range.value
																? 'bg-wedding-olive/20 text-wedding-olive font-medium'
										...
										<div>
											...
											>
												...
												<SelectContent>
													<SelectItem
														value="name-asc"
														className="focus:bg-wedding-olive/10 focus:text-wedding-olive"
													>
														Nome (A-Z)
													</SelectItem>
													<SelectItem
						...
						<div className="flex-1 min-w-0">
							...
							<div className="grid grid-cols-2 md:grid-cols-2 xl:grid-cols-3 gap-3 md:gap-6">
								...
								{filteredGifts.map((gift) => (
									<Card
										key={gift.id}
										className="bg-white/80 backdrop-blur-sm border-wedding-olive/20 hover:shadow-xl transition-all duration-300 flex flex-col h-full"
									>
										...
										<CardHeader className="flex-shrink-0 pb-2">
											<CardTitle className="text-foreground line-clamp-2 text-sm md:text-base">
												{gift.name}
											</CardTitle>
										</CardHeader>
								...
								{shouldShowPix && (
									<Card className="bg-white/80 backdrop-blur-sm border-wedding-olive/20 hover:shadow-xl transition-all duration-300 flex flex-col h-full">
										<div className="aspect-square bg-gray-100 rounded-t-lg overflow-hidden">
											{pixGift.image ? (
												<img
													src={pixGift.image}
							...
							{!shouldShowPix && filteredGifts.length === 0 && (
								<div className="text-center py-12">
									...
									<Button
										variant="outline"
										onClick={clearFilters}
										className="text-red-500 border-red-400 hover:bg-red-50 hover:text-red-600"
										onMouseMove={shineMove}
									>
				...
				<DialogContent className="sm:max-w-sm bg-white border-2 border-wedding-olive/30 rounded-2xl shadow-2xl p-0 overflow-hidden">
							...
							{selectedGift && (
								<DialogDescription className="text-gray-600 text-sm mt-1">
									...
									{selectedGift.minValue > 0 && (
										<span className="ml-1 text-wedding-olive font-medium">
											·{' '}
											{formatPrice(
												selectedGift.minValue,
												selectedGift.maxValue,
											)}
										</span>
									)}
								</DialogDescription>
					...
					<div className="px-6 py-5 space-y-4">
						...
						<div className="space-y-2">
							...
							<div className="relative flex items-center border-2 border-wedding-olive rounded-xl bg-white focus-within:ring-2 focus-within:ring-wedding-olive/40 focus-within:ring-offset-1 transition-all">
						...
						<div className="flex gap-3 pt-1">
							<Button
								...
								className="btn-shine-olive flex-1 border-wedding-olive/40 text-gray-600 hover:border-wedding-olive hover:text-wedding-olive hover:bg-wedding-olive/5 h-11"
								onMouseMove={shineMove}
							>
								Cancelar
							</Button>
							<Button
								onClick={() => {
									if (selectedGift) openPixModal(selectedGift, paymentAmount);
								}}
								disabled={paymentAmount <= 0}
								className="btn-shine-white flex-1 bg-wedding-olive hover:bg-wedding-olive/90 text-white h-11 font-semibold shadow-md disabled:opacity-40"
								onMouseMove={shineMove}
							>
								Continuar
							</Button>
			...
			<footer className="py-20 bg-white text-center">
				<div className="container mx-auto">
					<div data-gsap-footer className="max-w-2xl mx-auto">
						...
						<div className="w-full h-px bg-gradient-to-r from-transparent via-wedding-olive/30 to-transparent mt-10 mb-6" />
